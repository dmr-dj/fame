...
Last modified on Wed Jul 18 16:49:50 CEST 2018
...
def growth_rate_l09(nm_foram, input_T, norm=0, modstate=0):
...
def growth_rate_l09_array(nm_foram, input_T, norm=0, modstate=0):
